...
cellsize_input <- 40000 # distance between hex cell centers
n_input <- 130*50 # this may be superseded by cellsize; i have set it as approximately the expected number
